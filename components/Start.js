  ...
  return (
    <section className="max-w-[1000px] flex flex-col justify-center min-h-screen mx-auto my-0">
      <div className="pl-1 pb-6">
        <h1 className="text-orange-text font-SFMono font-semibold SFMono">
          Hi, my name is
        </h1>
      </div>
      ...
      <div className="text-gray-400 mt-5 text-base md:text-lg max-w-xl">
      ...
      <button className=" border border-orange-border text-orange-text py-4 px-3 w-56 rounded-md mt-12 hover:bg-orange-bg hover:bg-opacity-20">Check out my projects!</button>
    </section>
  )
}
