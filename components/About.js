...
function About() {
  return (
    <section className="min-h-screen flex max-w-[900px]  mx-auto">
      <div className="flex flex-col space-y-5 justify-center">
        ...
        <div className="flex flex-col md:grid md:grid-cols-5 gap-12">
          <div className="text-gray-400 space-y-3 col-span-3 text-base md:text-lg text-left">
            ...
            <ul className="grid grid-cols-2 list-none list-inside text-sm md:text-sm space-y-1">
          ...
          <div className="md:col-span-2 rounded w-64 h-64 relative self-center md:self-start">
            ...
            <div className="absolute w-64 h-64 rounded-lg bg-orange-bg z-30 mix-blend-multiply hover:hidden"></div>
          </div>
        </div>
      </div>
    </section >
